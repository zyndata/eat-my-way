...
- **kalendarz:** Raise the cooked portions when a meal is eaten beyond them
...
- **zakupy:** Keep a half-typed row out of the merge, and say „3 ząbki" for three pieces
...
- **icons:** Draw the icon set from the new brand SVG
